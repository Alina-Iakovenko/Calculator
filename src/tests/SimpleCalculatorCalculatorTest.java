...
public class SimpleCalculatorCalculatorTest {
    @Test
    public void test_Calculator_PlusMinus_Success()
    {
        String formula = "1+2-3";
        Double expectedResult = 0.0;
        assertEquals(expectedResult, SimpleCalculator.calculate(formula, null));
    }
    @Test
    ...
    public void test_Calculator_SimpleNegativeNumber_DoubleNegativePower_Exception()  {
        ...
        assertThrows(Exception.class, () -> SimpleCalculator.calculate(formula, null));
    }
    @Test
